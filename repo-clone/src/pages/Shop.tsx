...
export function Shop() {
  ...
  return (
    <div className="pt-32 pb-24 min-h-screen relative overflow-hidden">
        ...
        <div className="absolute bottom-0 left-0 w-[600px] h-[600px] bg-purple-600/5 blur-[120px] rounded-full -z-10" />

        <div className="container mx-auto px-6">
            {/* Shop Header */}
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-8 mb-12">
                <div className="space-y-4">
                    <h1 className="text-5xl font-bold tracking-tight text-black dark:text-white">Full Collection</h1>
                ...
                <div className="flex flex-wrap items-center gap-4">
                    <div className="relative group">
                        ...
                        <input 
                            ...
                            className="bg-black/5 dark:bg-white/5 border border-black/10 dark:border-white/10 rounded-full pl-12 pr-6 py-3 text-sm text-black dark:text-white focus:outline-none focus:border-blue-500/50 w-[300px] transition-all"
                            value={searchQuery}
