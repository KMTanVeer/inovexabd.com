                    ...
                    <div className="space-y-4">
                        <div className="flex items-center gap-3">
                            ...
                            <div className="flex items-center gap-1">
                                {[...Array(5)].map((_, i) => (
                                    <Star key={i} size={12} className={cn("fill-yellow-500", i < Math.floor(product.rating) ? "text-yellow-500" : "text-black/20 dark:text-white/20")} />
                                ))}
                                <span className="ml-2 text-xs font-bold text-black/40 dark:text-white/40">({product.rating})</span>
                            </div>
                        </div>
                        ...
                        >
                            {Object.entries(product.specs).map(([label, value]) => (
                                <div key={label} className="flex items-center justify-between py-4 border-b border-black/5 dark:border-white/5 bg-black/[0.01] dark:bg-white/[0.01] px-6 rounded-xl">
                                    ...
                                    <span className="text-sm font-bold text-black dark:text-white tracking-wide">{value}</span>
                                </div>
                            ))}
                        </motion.div>
                    )}
                        ...
                        >
                            <div className="flex items-center gap-8 py-10 px-8 rounded-3xl bg-black/[0.02] dark:bg-white/[0.02] border border-black/5 dark:border-white/5">
                                <div className="text-center space-y-2">
                                    ...
                                    <div className="text-[10px] font-bold text-black/30 dark:text-white/30 uppercase tracking-widest leading-loose">Based on 0 reviews</div>
                                </div>
                            ...
                            <div className="space-y-8">
                                <div className="p-8 rounded-2xl border border-black/5 dark:border-white/5 bg-black/[0.01] dark:bg-white/[0.01] text-center">
                                    <p className="text-black/50 dark:text-white/50 text-sm leading-relaxed mb-4">No reviews yet.</p>
