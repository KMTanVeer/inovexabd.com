        ...
        <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4 md:p-12">
          ...
          >
            <GlassContainer className="h-full flex flex-col md:flex-row overflow-y-auto md:overflow-hidden p-0 bg-[#050505]/95 border-white/10">
              ...
              <div className="w-full md:w-1/2 p-4 md:p-12 flex flex-col justify-center gap-4 md:gap-6">
                <div>
                  <div className="flex items-center gap-2 md:gap-3 mb-2 md:mb-4">
                    ...
                    <div className="flex items-center gap-1">
                      ...
                      <span className="text-xs md:text-sm font-bold text-white tracking-widest">{product.rating}</span>
                    </div>
                  </div>
                ...
                <div className="grid grid-cols-2 gap-2 md:gap-4">
                  {Object.entries(product.specs).map(([label, value]) => (
                    <div key={label} className="p-2 md:p-3 rounded-xl bg-white/[0.03] border border-white/5">
                      ...
                      <span className="block text-xs md:text-sm text-white font-medium truncate">{value}</span>
                    </div>
                  ))}
                </div>
                ...
                <div className="pt-4 md:pt-6 border-t border-white/5 flex flex-col md:flex-row items-start md:items-center justify-between gap-4 md:gap-6">
                  <div className="flex flex-col">
                    ...
                    <span className="text-2xl md:text-3xl font-bold text-white">0.00tk</span>
                  </div>
                  <a
